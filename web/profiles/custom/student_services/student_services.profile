 ...
 */
function student_services_install_tasks() {
    $tasks = [];
    ...
    $tasks['student_services_update_profile_config'] = [];
 ...
 */
function student_services_set_default_theme()
{
    Drupal::configFactory()
        ->getEditable('system.theme')
        ->set('default', 'ucr_default')
        ->set('admin', 'seven')
        ->save(TRUE);

    $uninstall_themes = ['bartik'];
 ...
 */
function student_services_set_file_settings()
{
 ...
 */
function student_services_set_user_roles_info()
{
 ...
 */
function student_services_set_text_editors()
{
 ...
 */
function student_services_set_add_to_any_settings()
{
 ...
 */
function student_services_set_menu_links()
{
 ...
 */
function student_services_update_core_config()
{
 ...
 */
function student_services_update_profile_config()
{
 ...
 */
function student_services_set_workflow_options()
{
 ...
 */
function student_services_set_layout_builder()
{
 ...
 */
function student_services_create_default_pages()
{
