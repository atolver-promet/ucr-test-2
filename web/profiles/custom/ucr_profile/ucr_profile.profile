 ...
 */
function ucr_profile_install_tasks() {
    $tasks = [];
    ...
    $tasks['ucr_profile_update_profile_config'] = [];
 ...
 */
function ucr_profile_set_default_theme() {
 ...
 */
function ucr_profile_set_file_settings() {
 ...
 */
function ucr_profile_set_user_roles_info() {
 ...
 */
function ucr_profile_set_text_editors() {
 ...
 */
function ucr_profile_set_add_to_any_settings() {
 ...
 */
function ucr_profile_set_menu_links() {
 ...
 */
function ucr_profile_update_core_config() {
 ...
 */
function ucr_profile_update_profile_config() {
 ...
 */
function ucr_profile_set_workflow_options() {
 ...
 */
function ucr_profile_set_layout_builder() {
 ...
 */
function ucr_profile_create_default_pages() {
